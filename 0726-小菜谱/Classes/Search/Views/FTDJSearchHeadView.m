...
@interface FTDJSearchHeadView()<FTDJSegmentControlDelegate>

@property (weak, nonatomic) UISegmentedControl *segmentControl7; // ios7
@property (nonatomic, strong) FTDJSegmentControl *segmentControl6; // ios6
...
@implementation FTDJSearchHeadView
...
{
    return [[[NSBundle mainBundle] loadNibNamed:@"FTDJSearchHeadView" owner:nil options:nil] lastObject];
}
...
- (void)setupSegmentControl
{
    if (iOS7) {
        ...
        // 如果是ios6 用自定义的控件
        self.segmentControl6 = [[FTDJSegmentControl alloc] init];
