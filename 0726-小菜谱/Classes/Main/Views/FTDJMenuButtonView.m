...
//#import "FTDJTitleBtn.h"

@interface FTDJMenuButtonView()
...
@implementation FTDJMenuButtonView

- (id)initWitFTDrame:(CGRect)frame
{
    self = [super initWithFrame:frame];
    if (self) {
        
        // 1.设置背景颜色
        self.backgroundColor = [UIColor colorWithRed:236/255. green:231/255. blue:231/255. alpha:1];
